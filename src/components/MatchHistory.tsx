...
function RuneIcon({
    ...
    // DDragon rune icons live at /cdn/img/<path>
                            ...
                            >
                                <div className="flex items-start justify-between gap-3">
                                    ...
                                    <div className="shrink-0 text-right text-xs text-zinc-500 tabular-nums space-y-1">
                                        <div>
                                            {m.cs ? <span className="text-zinc-300">   CS:{m.cs}</span> : "—"}
                                        </div>
                                        <div>
                                            Gold:{" "}
                                            <span className="text-zinc-300">{m.gold != null ? m.gold.toLocaleString() : "—"}</span>
                                        </div>
                                    </div>
                                </div>

                                {/* spells / runes / items (spaced out) */}
