        ...
        <header className="space-y-3">
          ...
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-zinc-400">
              Build a simple single-elim community event, then manage rounds and Riot tournament
              codes from your secret organizer link. {hostCodeRequired ? "The same community code is required here too." : ""}
            </p>
          </div>
        </header>

        <TournamentCreateForm hostCodeRequired={hostCodeRequired} />
      </div>
    </main>
  );
}
